...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    """Computes the molar mass of a molecule given its element composition."""
    molar_mass = 0
...
def main():
    #Main function to get user input and compute molar mass and number of moles.
    ...
    symbol_quantity_list = parse_formula(formula, periodic_table_dict=periodic_table)
